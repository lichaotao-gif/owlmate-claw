...
export function OwlLogo({ size = 32, className = '', title }: OwlLogoProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M10.5 34c3.3 1 6.2 3.8 7.8 8.4 1.3 3.8.8 7.6-.8 10.3C11.7 49.2 8.7 43.4 8.7 36c0-.7 0-1.4.1-2l1.7.1Z"
        fill="var(--owl-wing, #513B7C)"
      />
      <path
        d="M53.5 34c-3.3 1-6.2 3.8-7.8 8.4-1.3 3.8-.8 7.6.8 10.3 5.8-3.5 8.8-9.3 8.8-16.7 0-.7 0-1.4-.1-2l-1.7.1Z"
        fill="var(--owl-wing, #513B7C)"
      />
      <path
        d="M19.5 45.5c3.6 2.2 7.8 3.3 12.5 3.3s8.9-1.1 12.5-3.3C42.8 53.3 38.2 58 32 58s-10.8-4.7-12.5-12.5Z"
        fill="var(--owl-belly, #826BAC)"
      />
      ...
      <path
        d="m32 34.2 5 4.3-5 4.1-5-4.1 5-4.3Z"
        fill="var(--owl-beak, #69D7DD)"
      />
    </svg>
  );
}
